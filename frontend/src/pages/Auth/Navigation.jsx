...
const logoutHandler = async()=>{
  ...
  return (
    <div style={{ zIndex:999 }} id='navigation-container'
        className={`${showSidebar?"hidden":"flex"} lg:flex xl:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%] h-[100vh] fixed`}>
          <div className="flex flex-col justify-center space-y-4">
            <Link to="/" className="flex items-center transition-transform transform hover:translate-x-2"><AiOutlineHome size={26} className="mr-2 mt-[3rem]"/>
