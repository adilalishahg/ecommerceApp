              ...
              <div className="flex flex-col w-[80%]">
                ...
                {cartItems.map((item) => (
                  <div key={item._id} className="flex mb-[1rem] pb-2 items-center">
                    ...
                    <div className="w-24">
                      <select className="w-full p-1 text-black border rounded" value = {item.qty}
                    ...
                    <div>
                      <button className="text-red-500 mr-[5rem]" onClick={()=>removeFromCartHandler(item._id)}>
                        <FaTrash className="ml-[1rem] mt-[.25rem]"/>
                      </button>
                    </div>
                  </div>
                ...
                <div className="mt-8 w-[40rem]">
                  <div className="p-4 rounded-lg">
                    ...
                    <button className="w-full px-4 py-2 mt-4 text-lg bg-pink-500 rounded-full" disabled ={cartItems.length===0}
